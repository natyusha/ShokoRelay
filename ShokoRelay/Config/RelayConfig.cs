...
namespace ShokoRelay.Config
{
    ...
    public class RelayConfig
    {
        ...
        [Display(Name = "Collection Posters", Description = "Enable to use the primary series poster in a group for the collection poster.")]
        [DefaultValue(true)]
        public bool CollectionPosters { get; set; } = true;

        [Display(Name = "Plex Theme Music", Description = "Enable to grab theme music files from Plex (uses TheTVDB IDs).")]
        [DefaultValue(true)]
        ...
        [Display(Name = "Tag Blacklist", Description = "A list of tags to exclude from series in Plex, separated by a comma.")]
        [DefaultValue("")]
        ...
        [Display(Name = "VFS Parallelism", Description = "Maximum concurrent series to process during VFS builds.")]
        [DefaultValue(4)]
        ...
        [Display(Name = "Collection Posters Root Path", Description = "The location of the local collection posters inside each import root.")]
        [DefaultValue("!CollectionPosters")]
        public string CollectionPostersRootPath { get; set; } = "!CollectionPosters";

        [Display(Name = "AnimeThemes Root Path", Description = "The location of the AnimeThemes files inside each import root.")]
        [DefaultValue("!AnimeThemes")]
        public string AnimeThemesRootPath { get; set; } = "!AnimeThemes";

        [Display(Name = "AnimeThemes Path Mapping", Description = "The base path for the AnimeThemes files (used when generating a mapping).")]
        [DefaultValue("/animethemes/")]
        ...
        [Display(Name = "Sync Plex Watched", Description = "Enable automatic sync of watched state from Plex to Shoko (periodic).")]
        [Browsable(false)]
        [DefaultValue(false)]
        public bool SyncPlexWatched { get; set; } = false;
