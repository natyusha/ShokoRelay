...
namespace ShokoRelay.Config
{
    ...
    public class RelayConfig
    {
        ...
        [Display(Name = "TMDB Season Posters", Description = "Enable to use TMDB season posters for multi-season series. [not implemented]")]
        [DefaultValue(true)]
        public bool TMDBSeasonPosters { get; set; } = true;

        [Display(Name = "TMDB Thumbnails", Description = "Enable to use TMDB episode thumbnails instead of ones generated by Plex.")]
        [DefaultValue(false)]
