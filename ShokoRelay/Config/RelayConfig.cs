...
public class AdvancedConfig
{
    ...
    /// <summary>Whether to sync episode thumbnails generated by Plex back to Shoko to avoid the need for TMDB thumbnails.</summary>
    [Display(Name = "Plex Image Sync", Description = "Enable to automatically upload episode thumbnails that Plex generates back to Shoko")]
    [DefaultValue(false)]
    [VfsRebuild]
