...
namespace ShokoRelay.Plex
{
    ...
    public static class PlexConstants
    {
        ...
        public static class LocalMediaAssets
        {
            ...
            /// <summary>Supported subtitle extensions, separate from other episode sidecars.</summary>
            public static readonly FrozenSet<string> SubtitleExtensions = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { ".srt", ".smi", ".ssa", ".ass", ".vtt" }.ToFrozenSet(
