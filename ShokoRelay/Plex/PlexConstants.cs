namespace ShokoRelay.Plex
{
    ...
    public static class PlexConstants
    {
        ...
        public const int SeasonUnknown          = -99;
        ...
        // Includes Plex extras subtype to match the Plex API spec.
        public static readonly IReadOnlyDictionary<int, (string Folder, string Prefix, string Subtype)> ExtraSeasons = new Dictionary<int, (string Folder, string Prefix, string Subtype)>
        {
            { SeasonCredits, ("Shorts", "Credits", "short") },
            { SeasonTrailers, ("Trailers", "Trailers", "trailer") },
            { SeasonParody, ("Scenes", "Parody", "sceneOrSample") },
            { SeasonOther, ("Featurettes", "Other", "featurette") },
            { SeasonUnknown, ("Other", "Unknown", "other") },
        };
